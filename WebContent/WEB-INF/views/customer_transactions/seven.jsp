...
%>
<div class="center">
	<h2 align="center">Personalized Movie List</h2>
...
<%   
   ...
   ResultSet rs = stmt.executeQuery( "SELECT M.Id, M.Name, M.Type " +
		   "FROM Movie M "+
		   "WHERE M.Type IN (SELECT O.movieType FROM PastOrder O "+
		   		"WHERE O.CustId = '" + userId + "') AND M.Id NOT IN (SELECT O.MovieId FROM PastOrder O "+
		   	     "WHERE O.CustId = '" + userId + "')");
   int count = 0;
